    ...
    return (
        ...
        <div className="flex flex-col gap-8 md:py-2 items-center justify-center z-100">
            ...
            <div className='flex flex-col gap-8'>
                    <h1 className=" text-4xl md:text-6xl text-center"><span className='italic'>Welcome to </span><br/><span className='text-5xl md:text-7xl font-serif font-extrabold'>Stumps & Stories! </span><br /><span className='text-2xl md:text-4xl font-serif font-medium'>Get Ready to Experience Cricket beyond the scoreboard...</span></h1>
            </div>
